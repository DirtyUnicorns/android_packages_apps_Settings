...
public class Utilities {
	...
	public static String getStatsUrl() {
		String returnUrl = SystemProperties.get("ro.romstats.url", "http://stats.dirtyunicorns.com/");
	...
	public static String getRomName() {
		return SystemProperties.get("ro.romstats.name", "DirtyUnicorns");
	}

	public static String getRomVersion() {
		return SystemProperties.get("ro.romstats.version", "7.9");
	}
