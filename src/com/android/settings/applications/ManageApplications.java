...
public class ManageApplications extends Fragment implements
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.add(0, SHOW_BACKGROUND_PROCESSES, 4, R.string.show_background_processes)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, APP_MOVING_ENABLE, 5, R.string.app_moving_enable)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        menu.add(0, APP_MOVING_DISABLE, 6, R.string.app_moving_disable)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        menu.add(0, RESET_APP_PREFERENCES, 7, R.string.reset_app_preferences)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        updateOptionsMenu();
    }
