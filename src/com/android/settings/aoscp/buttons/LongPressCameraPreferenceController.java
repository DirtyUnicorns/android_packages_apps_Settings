...
public class LongPressCameraPreferenceController extends BasePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        int value = Settings.System.getInt(mContext.getContentResolver(), KEY_CAMERA_LONG_PRESS_ACTION, defaultBehavior);
    ...
    public CharSequence getSummary() {
        int value = Settings.System.getInt(mContext.getContentResolver(), KEY_CAMERA_LONG_PRESS_ACTION, 0);
