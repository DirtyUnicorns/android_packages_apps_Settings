...
public class DoubleTapAppSwitchPreferenceController extends BasePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        int value = Settings.System.getInt(mContext.getContentResolver(), KEY_APP_SWITCH_DOUBLE_TAP_ACTION, defaultBehavior);
    ...
    public CharSequence getSummary() {
        int value = Settings.System.getInt(mContext.getContentResolver(), KEY_APP_SWITCH_DOUBLE_TAP_ACTION, 0);
